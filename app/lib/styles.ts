...
export const buttonSecondaryClasses =
  "font-body text-sm sm:text-base rounded-xl border border-bridge-border bg-white text-bridge-text px-6 py-3 font-medium shadow-sm transition-all duration-300 ease-out hover:bg-bridge-surface hover:shadow-md hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-bridge-border focus:ring-offset-2";
